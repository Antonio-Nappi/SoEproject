...
/**
 * Describes the behavior of the player controllable via keyboard. Is used to
 * manage the behavior of the player calculating where it can move and directing
 * the moviment. it is also delegated to manage the undermining the bombs.
 *
...
public class Player extends Mob {
     ...
     * calculates the movement and it checks if he has placed a bomb.
     */
    @Override
    public void update() {
        clearBombs();
